...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Navigasi Dasa Wisma -->
            <li class="nav-item {{ Request::is('user/dasawisma') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('user.dasawisma.laporan.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('user.dasawisma.laporan.statistikdesa') }}">
