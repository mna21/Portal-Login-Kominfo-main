...
<div class="container mt-5">
    <div class="card shadow-sm p-4 mb-4 bg-white rounded">
        ...
        <form action="{{ route('user.datapenduduk.store') }}" method="POST">
            @csrf
            ...
            <div class="d-grid gap-2">
                ...
                <a href="{{ route('user.datapenduduk.index', ['dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $kepala_rumah_tangga_id, 'no_kk' => $no_kk]) }}" class="btn btn-secondary btn-block">Batal</a>
            </div>
