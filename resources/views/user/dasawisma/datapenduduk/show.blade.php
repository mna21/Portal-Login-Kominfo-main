...
<div class="container mt-5">
    <div class="card shadow-sm p-4 mb-4 bg-white rounded">
        ...
        <a href="{{ route('user.datapenduduk.index', ['dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $keluarga->kepala_rumah_tangga_id ?? null, 'no_kk' => $keluarga->no_kk]) }}" class="btn btn-secondary">Kembali</a>
