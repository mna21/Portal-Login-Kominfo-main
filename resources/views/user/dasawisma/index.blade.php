        ...
        <div class="card shadow-lg h-100 py-2" style="border-radius: 15px;">
            <div class="card-body" style="border-radius: 15px;">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary">Data Dasawisma</h6>
                </div>
                ...
                <!-- Form pencarian -->
                <form action="{{ route('user.dasawisma.index') }}" method="GET" class="mb-3">
                ...
                <div class="alert alert-warning text-center">
                    Tidak ada data Dasa Wisma. <a href="{{ route('user.dasawisma.create') }}" class="alert-link">Buat sekarang</a>.
                </div>
                @endif
                ...
                <div class="d-flex justify-content-start mt-4">
                    <a href="{{ route('user.dasawisma.create') }}" class="btn btn-success mr-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                                        <a href="{{ route('user.dasawisma.kepalaRumahTangga', $item->id) }}" class="btn btn-primary btn-sm">KRT</a>
                                        <a href="{{ route('user.dasawisma.show', $item->id) }}" class="btn btn-info btn-sm">Lihat</a>
                                        <a href="{{ route('user.dasawisma.edit', $item->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                        <form action="{{ route('user.dasawisma.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus Dasa Wisma ini?');">
                                            @csrf
                                            @method('DELETE')
