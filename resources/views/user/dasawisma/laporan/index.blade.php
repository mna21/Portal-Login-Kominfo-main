        ...
        <div class="card shadow-lg h-100 py-2" style="border-radius: 15px;">
            <div class="card-body" style="border-radius: 15px;">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary">Daftar Dasawisma</h6>
                </div>
                ...
                <div class="card-footer text-center" style="border-radius: 15px;">
                    <div class="btn-group" role="group">
                        ...
                        <a href="{{ route('user.dasawisma.laporan.statistikdesa') }}" class="btn btn-primary btn sm">
                            <i class="fas fa-fw fa-chart-bar"></i>
                            Statistik
                        </a>

                        <a href="{{ route('user.dasawisma.laporan.laporanDawisPDF') }}" class="btn btn-success">
