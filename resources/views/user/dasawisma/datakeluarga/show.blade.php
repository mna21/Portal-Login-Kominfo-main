@extends('user.admin') <!-- Pastikan ini mengarah ke layout yang benar -->
...
<div class="container">
    ...
    <form action="{{ route('user.datakeluarga.destroy', [$dataKeluarga->no_kk, $dataKeluarga->dawis_id]) }}" method="POST" style="display:inline-block;">
        @csrf
        @method('DELETE')
