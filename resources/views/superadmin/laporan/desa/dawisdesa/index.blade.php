            ...
            <div class="card-body" style="border-radius: 15px;">
                ...
                <div class="card-footer text-center" style="border-radius: 15px;">
                    <div class="btn-group" role="group">
                        <a href="{{ route('superadmin.laporan.desa.index', ['no_prop' => $no_prop, 'no_kab' => $no_kab, 'no_kec' => $no_kec]) }}" class="btn btn-secondary">
                        ...
                        <a href="{{ route('superadmin.laporan.desa.dawisdesa.laporanDawisPDF', [
                                                    'no_prop' => $data->no_prop,
                                                    'no_kab' => $data->no_kab,
                                                    'no_kec' => $data->no_kec,
                                                    'no_kel' => $data->no_kel
