@extends('superadmin.admin')  <!-- Menggunakan layout AdminLTE atau layout yang sudah ada -->
        ...
        <div class="card shadow-lg h-100 py-2" style="border-radius: 15px;">
            ...
            <div class="card-footer text-center" style="border-radius: 15px;">
                <div class="btn-group" role="group">
                    <a href="{{ route('superadmin.laporan.desa.index', ['no_prop' => $no_prop, 'no_kab' => $no_kab, 'no_kec' => $no_kec]) }}" class="btn btn-primary">
...
<script>
    ...
    console.log('Datalabels Plugin:', ChartDataLabels);
    ...
    var statistikChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Jumlah',
                data: @json($chartData['values']).map(value => value ?? 0),   // Data untuk sumbu y
        ...
        plugins: [] // Enable the plugin for data label
    });
</script>
