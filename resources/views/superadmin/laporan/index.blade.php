        ...
        <div class="card shadow-lg h-100 py-2" style="border-radius: 15px;">
            <div class="card-body" style="border-radius: 15px;">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <!-- Tombol Laporan -->
                                        <a href="{{ route('superadmin.laporan.desa.index', [
                                            'no_kec' => $data->no_kec, 
                                            'no_kab' => $data->no_kab, 
                ...
                <div class="card-footer text-center" style="border-radius: 15px;">
                    <div class="btn-group" role="group">
                        <a href="{{ route('superadmin.laporan.statistik') }}" class="btn btn-primary">
                                        <i class="fas fa-fw fa-chart-bar"></i>
                                        Statistik
                                    
                        </a>

                        <a href="{{ route('superadmin.laporan.downloadPdf') }}" class="btn btn-success">
