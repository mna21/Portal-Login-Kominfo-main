    ...
    <div class="col-xl-12 mb-4">
        <div class="card shadow-lg h-100 py-2" style="border-radius: 15px;">
            <div class="card-body" style="border-radius: 15px;">
                ...
                <!-- Form pencarian -->
                <form action="{{ route('superadmin.dasawisma.index') }}" method="GET" class="mb-3">
                ...
                <div class="alert alert-warning text-center">
                    Tidak ada data Dasa Wisma. <a href="{{ route('superadmin.dasawisma.create') }}" class="alert-link">Buat sekarang</a>.
                </div>
                @endif
                ...
                <div class="d-flex justify-content-start mt-4">
                    <a href="{{ route('superadmin.dasawisma.create') }}" class="btn btn-success mr-3">
                ...
                <div class="mt-3">
                    <a href="{{ route('superadmin.dasawisma.index') }}" class="btn btn-secondary">Kembali</a>
                </div>
                @endif
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                                        <a href="{{ route('superadmin.dasawisma.kepalaRumahTangga', $item->id) }}" class="btn btn-primary btn-sm">KRT</a>
                                        ...
                                        <form action="{{ route('superadmin.dasawisma.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus Dasa Wisma ini?');">
                                            @csrf
                                            @method('DELETE')
