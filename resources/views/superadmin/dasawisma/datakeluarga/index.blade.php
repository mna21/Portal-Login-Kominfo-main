...
<div class="container mt-4">
    <div class="card shadow-sm p-4 mb-4 bg-white rounded">
        ...
        <div class="d-flex justify-content-start my-3">
            <a href="{{ route('superadmin.datakeluarga.create', [$dawis_id, $kepala_rumah_tangga_id]) }}" class="btn btn-primary">
                    ...
                    <tr class="text-center align-middle">
                        ...
                        <td class="text-center">
                            ...
                            <div class="btn-group" role="group">
                                <a href="{{ route('superadmin.datapenduduk.index', ['dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $keluarga->kepala_rumah_tangga_id ?? null, 'no_kk' => $keluarga->no_kk ?? 0]) }}" class="btn btn-secondary btn-sm">
                                    <i class="fas fa-list"></i> Penduduk
                                </a>

                                <a href="{{ route('superadmin.datakeluarga.show', ['no_kk' => $keluarga->no_kk, 'dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $keluarga->kepala_rumah_tangga_id ?? null]) }}" class="btn btn-info btn-sm">
                                    <i class="fas fa-eye"></i> Detail
                                </a>


                                <a href="{{ route('superadmin.datakeluarga.edit', [$keluarga->no_kk, $keluarga->dawis_id, $keluarga->kepala_rumah_tangga_id ?? 0]) }}" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>

                                <form action="{{ route('superadmin.datakeluarga.destroy', [$keluarga->no_kk, $keluarga->dawis_id, $keluarga->kepala_rumah_tangga_id]) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="card-footer text-center">
            <a href="{{ route('superadmin.dasawisma.kepalaRumahTangga', $dawis_id) }}" class="btn btn-secondary">
