...
<div class="container">
    ...
    <div class="d-flex justify-content-between mt-3">
        <a href="{{ route('superadmin.dasawisma.edit', $dawis->id) }}" class="btn btn-warning">Edit</a>
        <form action="{{ route('superadmin.dasawisma.destroy', $dawis->id) }}" method="POST" style="display:inline-block;">
            @csrf
            @method('DELETE')
    ...
    <div class="mt-2">
        <a href="{{ route('superadmin.dasawisma.index') }}" class="btn btn-secondary">Kembali ke Daftar Dasa Wisma</a>
    </div>
</div>
@endsection