...
<div class="container mt-5">
    ...
    <form action="{{ route('superadmin.dasawisma.kepalaRumahTangga.store', ['dawisId' => $dawisId]) }}" method="POST">
        @csrf
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="{{ route('superadmin.dasawisma.index') }}" class="btn btn-danger">Kembali</a>
        </div>
    </form>
</div>
@endsection