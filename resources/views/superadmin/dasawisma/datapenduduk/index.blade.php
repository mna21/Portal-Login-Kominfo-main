    ...
    <div class="card shadow-sm mb-4 bg-white rounded">
        ...
        <div class="card-body">
            ...
            <div class="d-grid gap-2 mt-4">
                <a href="{{ route('superadmin.datapenduduk.create', ['dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $kepala_rumah_tangga_id, 'no_kk' => $no_kk]) }}" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('superadmin.datapenduduk.show', ['id' => $penduduk->id, 'no_kk' => $penduduk->no_kk]) }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('superadmin.datapenduduk.edit', ['dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $kepala_rumah_tangga_id, 'no_kk' => $no_kk, 'id' => $penduduk->id]) }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('superadmin.datapenduduk.destroy', ['id' => $penduduk->id, 'no_kk' => $penduduk->no_kk, 'dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $kepala_rumah_tangga_id]) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="card-footer text-center">
            <a href="{{ route('superadmin.datakeluarga.index', ['dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $kepala_rumah_tangga_id]) }}" class="btn btn-secondary">
