...
<div class="container mt-5">
    <div class="card shadow-sm p-4 mb-4 bg-white rounded">
        ...
        <form action="{{ route('superadmin.datapenduduk.update', ['no_kk' => $penduduk->no_kk]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="d-grid gap-2">
                ...
                <a href="{{ route('superadmin.datapenduduk.index', ['dawis_id' => $dawis_id, 'kepala_rumah_tangga_id' => $keluarga->kepala_rumah_tangga_id ?? null, 'no_kk' => $keluarga->no_kk]) }}" class="btn btn-secondary btn-block">Batal</a>
            </div>
