...
<div class="container mt-5">
    ...
    <form action="{{ route('superadmin.kepalaRumahTangga.update', ['id' => $kepalaRumahTangga->id]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="{{ route('superadmin.dasawisma.kepalaRumahTangga', ['dawisId' => $dawisId]) }}" class="btn btn-danger">Kembali</a> {{-- Gantilah dawis_id dengan dawisId --}}
        </div>
    </form>
