...
class UserDataKeluargaController extends Controller
{
    public function index($dawis_id, $kepala_rumah_tangga_id = null, $no_kk = null)
    {
        ...
        return view('user.dasawisma.datakeluarga.index', compact(
            'dawisName',
            'no_kk',
            'dawis',
            'dataKeluarga',
    ...
    public function create($dawis_id, $kepala_rumah_tangga_id = null)
    {
        ...
        return view('user.dasawisma.datakeluarga.create', compact(
            'dawisName',
            'dawisId',
            'provinsi',
            'kepala_rumah_tangga_id',
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.datakeluarga.index', [
            'dawis_id' => $request->dawis_id,
            'kepala_rumah_tangga_id' => $request->kepala_rumah_tangga_id
    ...
    public function show($no_kk, $dawis_id, $kepala_rumah_tangga_id = null)
    {
        ...
        return view('user.dasawisma.datakeluarga.show', compact(
            'dataKeluarga',
            'provinsi'
        ));
    }
    ...
    public function edit($no_kk, $dawis_id, $kepala_rumah_tangga_id)
    {
        ...
        // Mengirim data ke view
        return view('user.dasawisma.datakeluarga.edit', compact(
            'keluarga',
            'dawisList',
            'kelurahan',
            'kecamatan',
