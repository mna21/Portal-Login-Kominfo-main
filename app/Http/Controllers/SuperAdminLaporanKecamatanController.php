...
class SuperAdminLaporanKecamatanController extends Controller
{
    ...
    public function statistik()
    {
       ...
       // Hitung total keseluruhan dari semua kecamatan
        ...
        return view('superadmin.laporan.statistik', [
    ...
    public function downloadPdf()
    {
        ...
        $totalKeseluruhan = DB::table('data_keluarga as dk')
            ...
            $pdf = PDF::loadView('superadmin.laporan.laporanKecPDF', [
                'dataPerKecamatan' => $dataPerKecamatan,
                'totalKeseluruhan' => $totalKeseluruhan
            ])
