...
class SuperAdminDasaWismaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('superadmin.dasawisma.index', compact('dasawisma'));
    }
    ...
    public function create()
    {
        ...
        return view('superadmin.dasawisma.create', compact('provinsi', 'kabupaten', 'kecamatan', 'kelurahan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.dasawisma.index')->with('success', 'Data Dasa Wisma berhasil disimpan.');
    }

    public function show($id)
    {
        $dawis = Dawis::with(['provinsi', 'kabupaten', 'kecamatan', 'kelurahan'])->findOrFail($id);
        return view('superadmin.dasawisma.show', compact('dawis'));
    }
    ...
    public function kepalaRumahTangga($id)
    {
        ...
        return view('superadmin.dasawisma.kepalaRumahTangga', [
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.dasawisma.edit', compact('dasaWisma', 'provinsi', 'kabupaten', 'kecamatan', 'kelurahan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('superadmin.dasawisma.index')->with('success', 'Data Dasa Wisma berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('superadmin.dasawisma.index')->with('success', 'Data Dasa Wisma berhasil dihapus.');
    }
}
