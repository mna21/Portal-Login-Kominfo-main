...
class SuperAdminKepalaRumahTanggaController extends Controller
{
    ...
    public function create($dawisId)
    {
        ...
        return view('superadmin.dasawisma.kepalaRumahTanggaCreate', [
            'dawisId' => $dawisId,
    ...
    public function store(Request $request, $dawisId)
    {
        ...
        return redirect()->route('superadmin.dasawisma.kepalaRumahTangga', $dawisId)->with('success', 'Kepala Rumah Tangga berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.dasawisma.kepalaRumahTanggaEdit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('superadmin.dasawisma.kepalaRumahTangga', $kepalaRumahTangga->dawis_id)
    ...
    public function show($dawisId, $id)
    {
        ...
        return view('superadmin.dasawisma.kepalaRumahTanggaShow', [
            'kepalaRumahTangga' => $kepalaRumahTangga,
            'dawisId' => $dawisId,               // Tambahkan variabel ini
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('superadmin.dasawisma.kepalaRumahTangga', $dawisId)
