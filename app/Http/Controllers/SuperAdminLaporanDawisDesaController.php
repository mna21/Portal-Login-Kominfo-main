...
class SuperAdminLaporanDawisDesaController extends Controller
{
    ...
    public function index($no_prop, $no_kab, $no_kec, $no_kel)
    {
        ...
        return view('superadmin.laporan.desa.dawisdesa.index', [
            'dawisData'=>$dawisData,
            'totals' =>$totals,
            'no_prop' => $no_prop,
            'no_kab' => $no_kab,
    ...
    public function statistikDesa($no_prop, $no_kab, $no_kec, $no_kel)
    {
        // Query to get the data
        $dawisData = DB::table('data_keluarga AS dk')
            ->join('data_keluarga_akumulasi AS dka', 'dk.no_kk', '=', 'dka.no_kk')
        ...
        return view('superadmin.laporan.desa.dawisdesa.statistikdesa', [
            'dawisData' => $dawisData,
            'chartData'=> $chartData,
    ...
    public function downloadPdf($no_prop, $no_kab, $no_kec, $no_kel)
    {
       ...
       // Load PDF view
       $pdf = PDF::loadView('superadmin.laporan.desa.dawisdesa.laporanDawisPDF', [
        'dawisData' => $dawisData,
        'totals' => $totals
