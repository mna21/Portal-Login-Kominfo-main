...
class AdminLaporanDesaController extends Controller
{
    public function index($no_prop, $no_kab, $no_kec)
    {
        ...
        return view('admin.laporan.desa.index',[
    ...
    public function statistik($no_prop, $no_kab, $no_kec)
    {
        ...
        return view('admin.laporan.desa.statistikkecamatan', [
            'chartData' => $chartData,
    ...
    public function downloadPdf($no_prop, $no_kab, $no_kec)
    {
        ...
        // Load PDF view
        $pdf = PDF::loadView('admin.laporan.desa.laporanDesPDF', [
            'dataPerDesa' => $dataPerDesa,
            'totalKeseluruhan' => $totalKeseluruhan
