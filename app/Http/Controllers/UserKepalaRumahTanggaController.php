...
class UserKepalaRumahTanggaController extends Controller
{
    ...
    public function create($dawisId)
    {
        ...
        return view('user.dasawisma.kepalaRumahTanggaCreate', [
            'dawisId' => $dawisId,
    ...
    public function store(Request $request, $dawisId)
    {
        ...
        return redirect()->route('user.dasawisma.kepalaRumahTangga', $dawisId)->with('success', 'Kepala Rumah Tangga berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('user.dasawisma.kepalaRumahTanggaEdit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('user.dasawisma.kepalaRumahTangga', $kepalaRumahTangga->dawis_id)
    ...
    public function show($dawisId, $id)
    {
        ...
        return view('user.dasawisma.kepalaRumahTanggaShow', [
            'kepalaRumahTangga' => $kepalaRumahTangga,
            'dawisId' => $dawisId,               // Tambahkan variabel ini
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('user.dasawisma.kepalaRumahTangga', $dawisId)
