...
class UserDataPendudukController extends Controller
{
    ...
    public function index($dawis_id, $kepala_rumah_tangga_id = null, $no_kk = null)
    {
        ...
        return view('user.dasawisma.datapenduduk.index', compact('dataPenduduk', 'dawis_id', 'kepala_rumah_tangga_id', 'no_kk'));
    }
    ...
    public function create($dawis_id, $kepala_rumah_tangga_id = null, $no_kk = null)
    {
        ...
        return view('user.dasawisma.datapenduduk.create', compact(
            'shdks',
            'statusKawin',
            'pendidikans',
            'pekerjaans',
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.datapenduduk.index', [
    ...
    public function edit($no_kk)
    {
        ...
        // Kirim data ke view
        return view('user.dasawisma.datapenduduk.edit', compact(
            'penduduk',
            'dawis_id',
            'shdks',
            'statusKawin',
    ...
    public function show($id, $no_kk)
    {
        ...
        return view('user.dasawisma.datapenduduk.show', compact('penduduk', 'dawis_id', 'kepala_rumah_tangga_id', 'no_kk', 'keluarga'));
    }
}
